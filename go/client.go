// Package advice provides a Go client for the Advice Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/advice?utm_source=go&utm_medium=readme
package advice
...
const (
	baseURL        = "https://api.apiverve.com/v1/advice"
	defaultTimeout = 30 * time.Second
)

// Client is the Advice Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Advice Generator API client.
...
// Execute makes a request to the Advice Generator API.
