...
/**
 * Client for the Advice Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/advice?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/advice';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AdviceClient] {$message}\n";
        }
    }
}
